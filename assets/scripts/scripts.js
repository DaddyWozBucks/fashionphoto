...
.controller('SearchCtrl', ['$scope', '$sce', '$interval', 'Flickr'
, function($scope, $sce, $interval, Flickr){
	this.searchTags = [];
	this.userId = '';
...
const flickr = {
  KEY: '0dcdaf57835fe56c55753e242a947db9',
  SECRET: '97807172640e45ee',
...
.factory('Flickr', ['$http', '$q', '$cacheFactory', function($http, $q, $cacheFactory){
	...
	function searchTags (tags, userId) {
		...
		var reqUrl = flickr.URL + '?api_key=' + flickr.KEY + '&method=flickr.photos.search&tags=' + tags;
		if (userId) {
